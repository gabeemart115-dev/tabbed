  ...
  await resend.emails.send({
    ...
    html: `
      <div style="background:#000;color:#fff;font-family:sans-serif;padding:40px;max-width:480px;margin:0 auto;">
        ...
        <a href="${partyUrl}" style="display:block;background:#fff;color:#000;text-align:center;padding:14px;font-size:12px;font-weight:bold;text-transform:uppercase;letter-spacing:4px;text-decoration:none;margin-bottom:12px;">
          View Your Dashboard
        </a>
        <a href="${inviteUrl}" style="display:block;border:1px solid #3f3f46;color:#a1a1aa;text-align:center;padding:14px;font-size:12px;font-weight:bold;text-transform:uppercase;letter-spacing:4px;text-decoration:none;">
          Share Invite Link
        </a>
